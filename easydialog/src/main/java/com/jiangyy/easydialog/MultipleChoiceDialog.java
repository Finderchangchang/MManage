...
public class MultipleChoiceDialog {
    ...
    public static class Builder {
        ...
        class ViewHolder {
            ...
            public ViewHolder(View view) {
                ...
                lvListView = (ListView) view.findViewById(R.id.dialog_list);
    ...
    private static class ListAdapter extends BaseAdapter {
        ...
        class ViewHolder {
            ...
            public ViewHolder(View view) {
                mView = (TextView) view.findViewById(R.id.item_title);
                tvChoice = (TextView) view.findViewById(R.id.item_choice);
            }
        }
