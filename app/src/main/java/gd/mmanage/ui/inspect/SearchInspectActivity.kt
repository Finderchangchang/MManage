 ...
 * 从业人员信息管理
 * */
class SearchInspectActivity : BaseActivity<ActivitySearchEmployeeBinding>(), AbsModule.OnCallback {
    ...
    override fun init(savedInstanceState: Bundle?) {
        ...
        adapter = object : CommonAdapter<EmployeeModel>(this, answer_list, R.layout.item_employee) {
            override fun convert(holder: CommonViewHolder, model: EmployeeModel, position: Int) {
                ...
                holder.setOnClickListener(R.id.update_ll) {
                    startActivityForResult(Intent(this@SearchInspectActivity, AddInspectActivity::class.java)
        ...
        title_bar.setRightClick {
            startActivityForResult(Intent(this@SearchInspectActivity, ChoiceInspectActivity::class.java)
