...
public class Camera2Activity extends BaseCameraActivity {
    ...
    CameraDevice.StateCallback mStateCallback = new CameraDevice.StateCallback() {
        ...
        public void onError(@NonNull CameraDevice cameraDevice, int error) {
            ...
            cameraDevice.close();
            mCameraDevice = null;
            Toast.makeText(BaseApplication.Companion.getContext(), "相机开启失败，再试一次吧", Toast.LENGTH_LONG).show();
            mFinishCalled = true;
            finish();
        }
            ...
            mCameraDevice.createCaptureSession(Arrays.asList(surface, mImageReader.getSurface()), new CameraCaptureSession.StateCallback() {
                ...
                public void onConfigured(@NonNull CameraCaptureSession cameraCaptureSession) {
                    ...
                    try {
                        ...
                        e.printStackTrace();
                        Toast.makeText(BaseApplication.Companion.getContext(), "开启相机预览失败，再试一次吧", Toast.LENGTH_LONG).show();
                        mFinishCalled = true;
                        finish();
                    }
                }
    ...
    class ImageSaver implements Runnable {
        ...
        public void run() {
            ...
            try {
                 ...
                 * 拍照完成后返回MainActivity.
                 */
                BaseApplication.Companion.getMHandler().post(() -> {
