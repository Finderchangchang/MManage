...
public class CommonUtils {
    ...
    public static int dp2px(float dpValue) {
        final float scale = BaseApplication.Companion.getContext().getResources().getDisplayMetrics().density;
    ...
    public static int getNavigationBarHeightInPx() {
        ...
        Resources rs = BaseApplication.Companion.getContext().getResources();
